...
/*
this.findUpcomingPrograms(callback);
return;*/
...
Model.prototype.findUpcomingPrograms = function (callback) {
   ...
   console.log("findUpcomingPrograms");

  var dateObj = new Date();
   startTime = dateObj.toISOString();
      console.log("findUpcomingPrograms= "+ startTime);

   
   
   var startTime = "2015-07-28T22:00:00.000Z";
   var endTime = "2015-07-28T22:00:00.000Z";
...
Model.prototype.setcurrentlyViewingDetails = function (username, pgmId, date, time, title, channleNo, callback) {
