...
Model.prototype.findMoreLikeThisPrograms = function (collectionName, pgmStartTime, pgmEndTime ,cast,genre,callback) {
    ...
    epg_data_model.aggregate([
        ...
        { "$match": {
            ...
            $or: [
                {"genre": "Other"},
                {"cast": "Robin Roberts,George Stephanopoulos,Lara Spencer"}
            ]
        }
        }
