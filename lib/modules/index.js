...
Provider.prototype.getMoreLikeThisPrograms = function (collectionName, pgmStartTime, pgmEndTime,cast, genre, callback) {

    Model.findMoreLikeThisPrograms(collectionName, pgmStartTime, pgmEndTime,cast,genre, callback);
};
