...
Provider.prototype.getMoreLikeThisPrograms = function (collectionName, pgmStartTime, pgmEndTime,cast, genre,title, callback) {

    Model.findMoreLikeThisPrograms(collectionName, pgmStartTime, pgmEndTime,cast,genre,title,callback);
};
