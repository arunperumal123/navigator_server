...
Provider.prototype.getMoreLikeThisPrograms = function (collectionName, pgmStartTime, pgmEndTime, genre, callback) {

    Model.findMoreLikeThisPrograms(collectionName, pgmStartTime, pgmEndTime,genre, callback);
};
